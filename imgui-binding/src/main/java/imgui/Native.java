...
//     */
    ...
    static native void UpdateDisplaySize(float w, float h, float fb_w, float fb_h); /*
        ImGuiIO& io = ImGui::GetIO();
        io.DisplaySize = ImVec2(w, h);
        if (w > 0 && h > 0) {
            io.DisplayFramebufferScale = ImVec2((float) fb_w / w, (float) fb_h / h);
        }
    */

    static native void UpdateDeltaTime(float delta_time); /*
        ImGuiIO& io = ImGui::GetIO();
        io.DeltaTime = delta_time;
    */

    static native void UpdateMousePos(float mouseX, float mouseY); /*
        ImGuiIO& io = ImGui::GetIO();
        if (io.WantSetMousePos == false) {
            io.MousePos = ImVec2(mouseX, mouseY);
        }
    */

    static native void UpdateMouseState(boolean mouseDown0, boolean mouseDown1, boolean mouseDown2, boolean mouseDown3, boolean mouseDown4, boolean mouseDown5); /*
        ImGuiIO& io = ImGui::GetIO();
    ...
    */
    ...
    static native void UpdateImGui(ImGuiIO jImguiIO, ImGuiStyle jImguiStyle); /*
        ImGuiIO& io = ImGui::GetIO();
    ...
    */
    ...
    static native void NewFrame(); /*
        ImGui::NewFrame();
    */

    static native void EndFrame(); /*
        ImGui::EndFrame();
    */
    ...
    */
    ...
    static native void SetNextWindowPos(float x, float y, int cond); /*
