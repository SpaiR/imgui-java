 ...
 */
class ReturnTypeDefinitionNode(
    ...
    override fun copy() = ReturnTypeDefinitionNode(container.copy(), storage.copy())

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (javaClass != other?.javaClass) return false

        other as ReturnTypeDefinitionNode
    ...
    override fun toString(): String {
        return "ReturnTypeDefinitionNode(container=$container, storage=$storage)"
    }
}
