...
class BodyDefinitionNode(
    ...
    override fun copy() = BodyDefinitionNode(container.copy(), storage.copy())

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (javaClass != other?.javaClass) return false

        other as BodyDefinitionNode
    ...
    override fun toString(): String {
        return "BodyDefinitionNode(container=$container, storage=$storage)"
    }
}
