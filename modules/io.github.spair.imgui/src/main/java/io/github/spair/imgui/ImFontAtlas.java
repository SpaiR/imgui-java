...
import io.github.spair.imgui.flag.ImFontAtlasFlags;
...
public final class ImFontAtlas extends ImGuiStructDestroyable {
    ...
    static native void nInit(); /*
        jclass jImFontAtlasClass = env->FindClass("io/github/spair/imgui/ImFontAtlas");
    ...
    */
    ...
    /**
     * Build flags (see {@link ImFontAtlasFlags})
     */
