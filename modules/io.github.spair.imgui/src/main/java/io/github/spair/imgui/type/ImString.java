package io.github.spair.imgui.type;
...
public final class ImString implements Cloneable {
    ...
    public static final class InputData {
         ...
         * Alternatively you can provide {@link ImGuiInputTextFlags#CallbackResize} flag to the input text widgets to enable string resizing.
