...
public class ImGui {
    ...
    private static String tryLoadFromClasspath(final String fullLibName) {
        try (InputStream is = ImGui.class.getClassLoader().getResourceAsStream("io/github/spair/imgui/natives/java/native-bin/" + fullLibName)) {
            if (is == null) {
                return null;
            }
    ...
    */
    ...
    private static native void nInitInputTextData(); /*
        jclass jInputDataClass = env->FindClass("io/github/spair/imgui/type/ImString$InputData");
        ...
        jclass jImString = env->FindClass("io/github/spair/imgui/type/ImString");
