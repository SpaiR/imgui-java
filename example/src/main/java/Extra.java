...
public class Extra {
    ...
    private static final ImBoolean SHOW_IMGUI_CANVA_EDITOR_WINDOW = new ImBoolean(false);
    ...
    public static void show(final Application app) {
        ...
        ImGui.checkbox("Show ImGui Canva Demo Window", SHOW_IMGUI_CANVA_EDITOR_WINDOW);
        ...
        if (SHOW_IMGUI_CANVA_EDITOR_WINDOW.get()) {
            ExampleCanvaEditor.show(SHOW_IMGUI_CANVA_EDITOR_WINDOW);
        }
    }
}
